...
# De diagnostiek-tool-tests (incl. de zon-decompositie) zijn verhuisd naar
# tests/test_vent_diagnostics.py (rename tools/airflow_diagnostics.py →
# tools/vent_diagnostics.py, Project 13).
